...
public class DataSourceRegistry {
    ...
    private final XiaoHeiHeDynamicHkeyDataSource xiaoHeiHeDynamicHkeyDataSource;
    private final XiaoHeiHeNewsDynamicHkeyDataSource xiaoHeiHeNewsDynamicHkeyDataSource;
    private final TongHuaShunDataSource tongHuaShunDataSource;
    private final CaiLianSheDataSource caiLianSheDataSource;
    ...
    public void doInit() {
        typeDataSourceMap = new HashMap<String, DataSource>() {{
            ...
            put(HotDataKeyEnum.XIAO_HEI_HE.getValue(), xiaoHeiHeDynamicHkeyDataSource);
            put(HotDataKeyEnum.XIAO_HEI_HE_NEWS.getValue(), xiaoHeiHeNewsDynamicHkeyDataSource);
            ...
            put(HotDataKeyEnum.CAI_LIAN_SHE.getValue(), caiLianSheDataSource);
